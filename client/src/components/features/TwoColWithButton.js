...
export default ({
  ...
  description = "Study Planner is a platform that lets students plan group study sessions with other students. Student are able to register for a particular session and there is a maximum limit for a particular session to register in it.",
